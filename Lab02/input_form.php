                ...
                <form action="" method="post">
                    <ul>
                        ...
                        <li style="margin-top: 10px;">Hobby 
                            <div class="hobby">
                                <input type="checkbox" id="" value="Dance" name="hobby[]">
                                    <label for="hob1">Dance</label>
                                <br>
                                <input type="checkbox" id="" value="Volunteer" name="hobby[]">
                                    <label for="hob1">Volunteer</label>
                                    <br>
                                <input type="checkbox" id="" value="Research" name="hobby[]">
                                    <label for="hob1">Research</label>
                                    <br>
                                <input type="checkbox" id="" value="Food Review" name="hobby[]">
                                    <label for="hob1">Food Review</label>
                                    <br>
                                <input type="checkbox" id="" value="Travel" name="hobby[]">
